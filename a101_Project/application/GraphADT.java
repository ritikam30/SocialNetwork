...
public interface GraphADT {
  ...
  /**
   * Remove the edge from name1 to name2 from this graph. (edge is undirected and unweighted) 
   * If either vertex does not exist, or if an edge from name1 to name2 does not exist, no edge is
   ...
   * 
   * For the example graph, A-[B, C] getAdjacentVerticesOf(A) should return [B, C].
   * 
