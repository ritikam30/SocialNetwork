...
//  private ArrayList<String> theUndone; // List of commands that were undone
	...
	public Set<Person> getMutualFriends(String user1, String user2)
		...
		if (user1 == null || user2 == null) {
			throw new IllegalArgumentException(
					"Null string detected for one or both specified users");
		}
	...
	public List<Person> getShortestPath(String source, String target)
		...
		if (source == null || target == null) {
			throw new IllegalArgumentException(
					"Null string detected for one of the specified users");
		}
		...
		HashMap<Person, Person> predecesors = new HashMap<>(); // HashMap of form <Friend,
																// Predecessor>
		...
		while (!queue.isEmpty()) { // BFS Loop
			...
			for (int i = 0; i < friendsList.size(); ++i) { // Iterate through current person's
															// friends
